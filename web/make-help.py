...
WEB = '''<ul>
<li><strong>Windows:</strong> the map fills the big window; Inventory, Visible monsters and Visible items are on the right; Messages and Recall along the bottom.</li>
...
KEY_HINTS = [
    ...
    ('H', 'Auto-explore: walk to the nearest unexplored spot'),
    ('Backspace', 'Menu of all commands (also Ctrl+H)'),
...
parts.append(section('about', 'About the game',
                     guide.pop('What makes Quickband special')))
